...
function Portfolio () {
    return(
        ...
        <a href="https://mustache-mustangs.herokuapp.com/"  target="_blank" className="portfolio-item">
                <img src={portfolioImage2} className="portfolio-img" alt="Two of 6 images of kamas portfolio images"/>
        </a>

        <a href="https://kamacasta.github.io/Friendly-Parakeet_PW/" target="_blank" className="portfolio-item">
                <img src={portfolioImage3} className="portfolio-img" alt="Three of 6 images of kamas portfolio images"/>
            </a>

        <a href="https://kamacasta.github.io/Weather-Dashboard/"  target="_blank" className="portfolio-item">
                <img src={portfolioImage4} className="portfolio-img" alt="Four of 6 images of kamas portfolio images"/>
        </a>
